                        ...
                        <div className="row">
                            <div className="card col-md-3" style={{ width: 18 }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to="/calculus" className="btn btn-warning float-right" id="calculusBtn" target="_parent" onClick={() => this.props.setSlide(1)}>המשך לקרוא</Link>
                                </div>
                            </div>
                            ...
                            <div className="card col-md-3" style={{ width: 18 }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to="/induction" className="btn btn-warning float-right" id="inductionBtn" target="_parent" onClick={() => this.props.setSlide(1)}>המשך לקרוא</Link>
                                </div>
                            </div>
                            ...
                            <div className="card col-md-3" style={{ width: 18 }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to="/trig" className="btn btn-warning float-right" id="trigBtn" target="_parent" onClick={() => this.props.setSlide(1)}>המשך לקרוא</Link>
                                </div>
                            </div>
                        </div>
                    </div>
